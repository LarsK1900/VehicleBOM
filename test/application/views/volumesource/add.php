    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Volumesource Add</h3>
            </div>
            <?php echo form_open('volumesource/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="volumeName" value="<?php echo $this->input->post('volumeName'); ?>" class="form-control" id="volumeName" />
