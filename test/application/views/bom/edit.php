    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Bom Edit</h3>
            </div>
			<?php echo form_open('bom/edit/'.$bom['idBOM']); ?>
			<div class="box-body">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idIHS" class="form-control">
								...
								{
									$selected = ($ihs['idIHS'] == $bom['idIHS']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idSAP" class="form-control">
								...
								{
									$selected = ($sap['idSAP'] == $bom['idSAP']) ? ' selected="selected"' : "";
