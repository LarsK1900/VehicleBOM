    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Volumemonth Add</h3>
            </div>
            <?php echo form_open('volumemonth/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="idVolumeYears" class="form-control">
								...
								{
									$selected = ($volumeyear['idVolumeYears'] == $this->input->post('idVolumeYears')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="Month" value="<?php echo $this->input->post('Month'); ?>" class="form-control" id="Month" />
